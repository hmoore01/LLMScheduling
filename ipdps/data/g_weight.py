...
population_size = 20
w2 = weights.random_weights(4,population_size)
neighborhoods = []
...
with open('pop20_obj4_weight.csv', 'w', newline='') as file: # ==4 objs and 100 population
    writer = csv.writer(file)
    writer.writerows(w2)

with open('pop20_obj4_weight_n.csv', 'w', newline='') as file:
    writer = csv.writer(file)
