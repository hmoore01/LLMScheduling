...
def change_distribution(lut_list, func_distribution_arr, leftover_resource_time_arr, req_distribution_arr, original_req_distribution_arr):
    ...
    new_req_distribution_arr[:,1]=original_req_distribution_arr[0]
    new_req_distribution_arr[:,2]=original_req_distribution_arr[1]
    new_req_distribution_arr[:,3]=original_req_distribution_arr[2]
    new_req_distribution_arr[:,4]=original_req_distribution_arr[3]
