...
def main():
	...
	## req test
	A=np.array([0.9467935619243422,139.11313299240106,1.6135827805562974,7.49782056202392]) #SOFA (utility, total_energy_cost, carbon, water)
	B=np.array([0.9337363234375,165.99626688982858,1.8749013496270928,9.154328973373984]) #GreenC
	C=np.array([0.9337363234375,165.99626688982858,1.8749013496270928,9.154328973373984]) #Kimchi
	D=np.array([0.17235120000000004,210.54027011731935,1.3115526297445257,3.2193245779668027]) #GOFS
	...
	figure.savefig('plot-1-huawei.jpeg', dpi=1200, bbox_inches="tight")
