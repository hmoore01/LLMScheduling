...
def centre_distribution(lut_list, func_distribution_arr, leftover_resource_time_arr, req_distribution_arr):
    ...
    new_req_distribution_arr[:,1]=0.1
    new_req_distribution_arr[:,2]=0.4
    new_req_distribution_arr[:,3]=0.4
    new_req_distribution_arr[:,4]=0.1
